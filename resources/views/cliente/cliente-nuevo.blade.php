...
<div class="panel-body">
        ...
        <form id="form1" method="POST">
            <div class="row">
                ...
                <div class="form-group col-lg-6">
                    <label>DNI: *</label>
                    <input type="text" maxlength="8" id="txtDni" name="txtDni" class="form-control" value="{{ $cliente->dni or '' }}" required>
                </div>
                <div class="form-group col-lg-6">
                    <label>Mail: *</label>
                    <input type="mail" id="txtMail" name="txtMail" class="form-control" value="{{ $cliente->mail or '' }}" required>
                </div>
                <div class="form-group col-lg-6">
                    <label>Telefono: *</label>
                    <input type="tel" id="txtTelefono" name="txtTelefono" class="form-control" value="{{$cliente->telefono or ''}}">
                </div>
                <div class="form-group col-lg-6">
                    <label>Dirección: *</label>
                    <input type="tel" id="txtDireccion" name="txtDireccion" class="form-control" value="{{$cliente->direccion or ''}}">
                </div>
            </div>
            </div>
        </form>
