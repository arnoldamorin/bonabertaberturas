...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="/admin/productos/ingresostocks">Ingresos Stock</a></li>
    <li class="breadcrumb-item active">Modificar</li>
</ol>
<ol class="toolbar">
    <li class="btn-item"><a title="Nuevo" href="/admin/productos/ingresostocks/nuevo" class="fa fa-plus-circle" aria-hidden="true"><span>Nuevo</span></a></li>
    ...
    <form id="form1" method="POST">
        <div class="row">
            ...
            <div class="form-group col-lg-6">
                ...
                <input type="text" id="txtDescripcion" name="txtDescripcion" class="form-control" value="{{$ingresostock->descripcion or ''}}">
            </div>
            <div class="form-group col-lg-6">
                <label>Fecha: *</label>
                <input type="text" id="txtDescripcion" name="txtDescripcion" class="form-control" value="{{$ingresostock->descripcion or ''}}">
...
<script>
    ...
    function eliminar() {
        $.ajax({
            type: "GET",
            url: "{{ asset('admin/productos/ingresostocks/eliminar') }}",
            data: {
                id: globalId
            },
            async: true,
    ...
    function fBuscarProductos() {
        ...
        if ($("#txtDescrProducto").val() == "") {
            $.ajax({
                type: "GET",
                url: "{{ asset('admin/ingreso/buscarProductos') }}",
                data: {
                    id: idtipo_producto
                },
                async: true,
