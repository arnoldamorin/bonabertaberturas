...
<ol class="toolbar">
    ...
    <li class="btn-item"><a title="Recargar" href="#" class="fas fa-redo-alt" aria-hidden="true" onclick='window.location.replace("/admin/alumnos");'><span>Recargar</span></a></li>
...
<script>
	var dataTable = $('#grilla').DataTable({
        ...
        "pageLength": 25,
        "order": [[ 0, "asc" ]],
	    "ajax": "{{ route('alumno.cargarGrilla') }}"
	});
</script>
@endsection