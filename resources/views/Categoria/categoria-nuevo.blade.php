...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="/admin/sistema/curso/categoria">Men&uacute;</a></li>
    <li class="breadcrumb-item active">Modificar</li>
</ol>
<ol class="toolbar">
    <li class="btn-item"><a title="Nuevo" href="/admin/sistema/curso/categoria/nuevo" class="fa fa-plus-circle" aria-hidden="true"><span>Nuevo</span></a></li>
...
<script>
    ...
    function eliminar() {
        $.ajax({
            type: "GET",
            url: "{{ asset('admin/sistema/curso/categoria/eliminar') }}",
            data: { id:globalId },
            async: true,
            dataType: "json",
