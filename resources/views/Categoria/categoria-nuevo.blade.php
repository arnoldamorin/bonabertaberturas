...
<ol class="toolbar">
    ...
    <li class="btn-item"><a title="Eliminar" href="/admin/cursos/categoria/eliminar" class="fa fa-trash-o" aria-hidden="true" onclick="javascript: $('#mdlEliminar').modal('toggle');"><span>Eliminar</span></a>
    </li>
