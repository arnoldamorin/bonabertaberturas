<?php
    ...
    class ControladorPatente extends Controller
    {
        public function index()
        {
            ...
            if (Usuario::autenticado() == true) {
                if (!Patente::autorizarOperacion("PATENTESCONSULTA")) {
                    ...
                    return view('patente.patente-listar', compact('titulo'));
                }
            } else {
        ...
        public function nuevo()
        {
            ...
            return view('patente.patente-nuevo', compact('titulo'));
        }
        ...
        public function editar($id)
        {
            ...
            if (Usuario::autenticado() == true) {
                if (!Patente::autorizarOperacion("PATENTESMODIFICACION")) {
                    ...
                    return view('patente.patente-nuevo', compact('patente', 'titulo'));
                }
            } else {
                return redirect('admin/login');
            }
        ...
        public function guardar(Request $request)
        {
            try {
                ...
                if ($entidad->nombre == "") {
                    ...
                    return view('patente.patente-listar', compact('titulo', 'msg'));
                }
            } catch (Exception $e) {
                $msg["ESTADO"] = MSG_ERROR;
                $msg["MSG"] = ERRORINSERT;
            ...
            return view('patente.patente-nuevo', compact('msg', 'patente', 'titulo')) . '?id=' . $patente->idpatente;
        }
